...
export default function About() {
  ...
  return (
    <section className="border-[rgba(255,255,255,0.05)] border-solid border-t-[0.667px] w-full px-[48px] pt-[112px] pb-[112px] relative">
      <div className="relative mx-auto w-full max-w-[896px]">
        ...
        <div className="mt-16 border-t border-[rgba(255,255,255,0.05)] pt-16 -mx-[48px] px-[48px]">
